        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 text-zinc-600 text-lg leading-relaxed">
              ...
              <div className="grid grid-cols-2 gap-6 pt-6">
                <div>
                  ...
                  <p className="text-sm">Foco e constância para alcançar seus objetivos dentro e fora do tatame.</p>
                </div>
                <div>
                  <h4 className="font-bold text-zinc-900 text-xl mb-2">Respeito</h4>
                  <p className="text-sm">Honra aos mestres, parceiros de treino e à arte suave.</p>
                </div>
                <div>
                  <h4 className="font-bold text-zinc-900 text-xl mb-2">Família</h4>
                  <p className="text-sm">Um ambiente acolhedor onde todos se ajudam a evoluir.</p>
                </div>
                <div>
                  <h4 className="font-bold text-zinc-900 text-xl mb-2">Evolução</h4>
                  <p className="text-sm">Busca contínua pelo aperfeiçoamento técnico e mental.</p>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute bottom-8 left-8 bg-white p-6 rounded-xl shadow-xl max-w-xs">
              <p className="text-zinc-900 font-bold text-lg mb-1">"O Jiu Jitsu é a arte de usar a força do oponente contra ele mesmo."</p>
